...
public class MainFrame extends JFrame {
	...
	public MainFrame() throws HeadlessException {
		...
		middlePanel.setLayout(new GridLayout(8, 0));
		JLabel middleLabel=new JLabel("Swap");
		middleLabel.setAlignmentX(CENTER_ALIGNMENT);
		
		JButton leftArrow = new BasicArrowButton(BasicArrowButton.EAST);
		leftArrow.setBounds(middlePanel.getWidth()/4, imagePanel.getHeight()/3, 50, 20);
		
		JButton rightArrow = new BasicArrowButton(BasicArrowButton.WEST);
		rightArrow.setBounds(middlePanel.getWidth()/4, imagePanel.getHeight()*2/3, 50, 20);
